        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                if (isset($_SESSION['email'])) {
                    ...
                    <li><a href="#" data-toggle="modal" data-target="#loginmodal"><span class="fa fa-log-in"></span> Log in</a></li>
                    <li><a href="about_us.php"><span class="fa fa-th-list"></span> About Us</a></li>
