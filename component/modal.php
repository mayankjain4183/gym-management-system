    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 style="color:white;" class="color"><span class="fa fa-lock"></span> Login</h4>
        </div>
        <div class="modal-body">
          <form role="form" action="login_submit.php" method="POST">
            ...
            <div class="checkbox">
              ...
              <button type="submit" class="btn btn-default btn-success"><span class="fa fa-power-off"></span> Login</button>
          </form>
        </div>
